...
//        debugger
    ...
    AJS.toInit(function(){
        $("body").append($('<div id="content-hover-shadow"><div class="tl"></div>' +
                '<div class="tr"></div><div class="l"></div><div class="r"></div>' +
                '<div class="bl"></div><div class="br"></div><div class="b"></div></div>'));
